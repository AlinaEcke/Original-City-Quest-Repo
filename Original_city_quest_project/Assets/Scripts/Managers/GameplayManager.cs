...
public class GameplayManager : MonoBehaviour
{
    ...
    protected float characterSpeedFactor = 1.0f;
    ...
    public void InitializeCharacter(int tutorialPhase)
    {
        ...
        character.GetComponent<PlayerKinematicBehaviour>().Init(characterSpeedFactor, characterStrafeFactor, characterAlpha);
        if (learningPhase && !learningPhaseDone)
